...
// AuthScreen component - commented out for offline-only mode
// This component is no longer used since the app runs in offline mode by default
// Uncomment and restore if you want to add Supabase authentication back
